...
class PriceConverter {
  static String convertPrice(BuildContext context, double price, {String discount, String discountType}) {
    ...
    return '${Provider.of<SplashProvider>(context, listen: false).configModel.currencySymbol} ''${(price).toStringAsFixed(
      Provider.of<SplashProvider>(context, listen: false).configModel.decimalPointSettings,
